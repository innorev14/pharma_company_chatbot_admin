...
def send_friend_msg(aligo_token, sender, receiver, msg_title, msg_contents, image=None):
    ...
    sms_data={'apikey': get_secret("ALIGO_APIKEY"), #api key
            ...
            'receiver_1': receiver, # 수신자 연락처
            #'recvname_1': '홍길동1', # 수신자 이름
            'subject_1': msg_title, # 친구톡 제목
            'message_1': msg_contents, # 친구톡 내용
